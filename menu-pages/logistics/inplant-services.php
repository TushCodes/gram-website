...
<div class="main-top"><?php include('menu.php');?></div>
	...
	<section class="w3ls-bnrbtm py-2" id="about">
	    <div class="mb-4" style="height: 90vh;
            background-image: url('images/Inplant-Services.jpg');
...
<h1 class="px-2 py-0 mb-4" style="color: black; font-weight: 800; text-align: center;">Inplant Services</h1>
<p class="px-2 pb-2 mb-2 text-secondary" style="font-weight: 600; text-align: justify;">Our in-plant services help you to reduce costs, increase productivity, and get the best out of your most valuable resource: your people inventory. Gram SCS believes that all processes in the plant should be considered holistically and integrated with external logistics systems. To avoid the tendency to shift costs from one area to another, we analyse the complete system, including how the plant interfaces with inbound to manufacturing and outbound logistics.</p>
<p class="px-2 pb-2 mb-2 text-secondary" style="font-weight: 600; text-align: justify;">Gram SCS is dedicated to achieving the highest level of operating safety on your site. We invest substantial time building consistent processes and training to achieve our goal of zero recordable incidents.</p>
<p class="px-2 mt-3 text-secondary" style="font-weight: 600; text-align: justify;">Services include-
</p>
<ul class="px-4 mb-4 my-2 text-secondary" style="font-weight: 700; text-align: justify;">
   <li>Packing</li>
