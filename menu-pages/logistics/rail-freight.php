...
<img src="images/Rail-Freight.jpg" class="img-fluid mb-5" width="100%"></div>
<div class="container py-xl-1 py-lg-1">
			<div class="row">
				<div class="col-lg-12 pl-xl-1 mt-lg-0 mt-1">
<h1 class="px-2 py-0 mb-4" style="color: black; font-weight: 800; text-align: center;">Rail Freight</h1>
