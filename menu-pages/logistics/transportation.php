...
<img src="images/Transportation.jpg" class="img-fluid" width="100%" style="transform: translate(0%, -30%);"> </div>
<div class="container py-xl-1 py-lg-1">
			<div class="row">
				<div class="col-lg-12 pl-xl-1 mt-lg-0 mt-1">
<h1 class="px-2 py-0 mb-4" style="color: black; font-weight: 800; text-align: center;">Transportation</h1>
<p class="px-2 pb-2 mb-2 text-secondary" style="font-weight: 600; text-align: justify;">Our business division provides with primary and secondary transportation (including last mile and reverse logistics) services over long distances in a faster and more efficient manner. All kinds of cargo is transported over long distances with high-tech transportation facilities and unique reporting system for all our transportation solution.</p>
<p class="px-2 pb-2 mb-2 text-secondary" style="font-weight: 600; text-align: justify;">We are happy to provide innovative and technology-enabled transportation solutions and programs that will support your supply chain thus, ensuring a competitive advantage to our customers in the marketplace.</p>
<p class="px-2 pb-2 mb-2 text-secondary" style="font-weight: 600; text-align: justify;">Our services include multiple location delivery and pick up, open and containerized trucks, special transportation solutions for high value cargo, hazardous material handling, reefer services, transportation insurance, road transport and development of in-house service improvement analytical tools viz. Load Optimization, Truck Indenting, Fleet Optimization.</p>
<p class="px-2 pb-2 mb-2 text-secondary" style="font-weight: 600; text-align: justify;">We specialize in providing the following services to our clients:</p>

<ul class="px-4 pb-2 mb-4 text-secondary" style="font-weight: 700; text-align: justify;">
   <li>Primary & Secondary</li>
   <li>Distribution (Inter-city and Intra-city)</li>
