...
<head>
	...
	<!-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/whatshelp-widget@1.0.3/dist/whatshelp-widget.min.css"> -->
</head>

<body>
	<!-- <script src="https://cdn.jsdelivr.net/npm/whatshelp-widget@1.0.3/dist/whatshelp-widget.min.js"></script> -->
<!-- HEADER -->
	<!-- green margin -->
	<header id="home"><?php include "./component/header.php"; ?></header>
	<!-- //green margin -->

	<!-- navbar header -->
	<!-- navigation -->
	<div class="main-top"><?php include "./component/menu.php"; ?></div>
	<!-- //navigation -->
	<!-- //header 2 -->
...
<p class="text-colors mt-2">Japanese Manufacturers</p>
	...
	<section class="w3ls-bnrbtm" id="who">
		<div class="container-fluid py-3 information" style="padding-left: 40px;">
			<div class="row no-gutters">
				<div class="col-6 who-left-w3pvt">
					...
					<ul class="list-unstyled who-lists mt-4">
				...
				<div class="col-6 mt-xl-0 text-xl-right text-center" id="warehouse-image-container">
	...
	<section id="mission">
		<div class="container">
			<div class="row">
				<div class="col-6">
					<img class="img-fluid rounded" src="images/warehouse2.jpg" alt="" width="90%" style="height: 80vh; border: 5px double black;">
				</div>
				<div class="col-6 text-align-justify">
					<p style="font-size: 1.2rem;" class="ml-4 text-secondary">GRAM SCS fully believes in give & take principle. The more we take care of our employees, the better we get at managing their work. Hence at GRAM, employees are given equal growth opportunities irrespective of color, gender, religion etc.</p>
				</div>	
			</div>
		</div>
	</section>
					...
					<form action="#" method="post">
						<div class="row">
							...
							<div class="col-md-2 form-group pr-md-0 mt-md-0 mt-3">
								<button class="btn" type="submit" style="background-color: #82CF2B;">Subscribe</button>
							</div>
						</div>
					</form>
				</div>
	...
	<div class="copyright-w3ls py-4">
		<?php include "./component/copy.php"; ?>
	</div>
	<!-- //copyright -->
	<!-- move top icon -->
