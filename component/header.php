<div class="top-bar py-2" style="background-color:#82CF2B; height: 2.4rem; display: flex; align-items: center;">
			<div class="container-fluid">
				<div class="row">
					<div class="col-6 top-social-w3pvt-am mt-1 text-lg-left text-center">
						<div class="row">
					...
					<div class="col-6 top-social-w3pvt-am mt-1">
						<div class="row">
